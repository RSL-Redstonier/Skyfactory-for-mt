...
minetest.register_craft({
	...
	recipe = {
		{"equivalent_exchange_energy_collectors:red_matter", "equivalent_exchange_energy_collectors:antimatter", "equivalent_exchange_energy_collectors:red_matter"},
		{"equivalent_exchange_energy_collectors:antimatter", modname.."alchemical_chest", "equivalent_exchange_energy_collectors:antimatter"},
		{"equivalent_exchange_energy_collectors:red_matter", "equivalent_exchange_energy_collectors:antimatter", "equivalent_exchange_energy_collectors:red_matter"}
	}
})
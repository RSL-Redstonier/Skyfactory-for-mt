...
minetest.register_craft({
	...
	recipe = {
		...
		{"equivalent_exchange_energy_collectors:mobius_fuel", "equivalent_exchange_energy_collectors:aeternalis_fuel", "equivalent_exchange_energy_collectors:mobius_fuel"},
		{"equivalent_exchange_energy_collectors:alchemical_crystal", "default:chest", "equivalent_exchange_energy_collectors:alchemical_crystal"}
	}
})
...
-- input | output
grinder_recipes["default:sand"]		= {"skytest:dust",		2}
grinder_recipes["default:cobble"]		= {"default:gravel",	1}
grinder_recipes["default:gravel"]		= {"default:sand",		1}
...
minetest.register_abm({
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		...
		if fuel:get_count() < grind_consume_fuel
				or (fuel:get_name() ~= "default:coal_lump" and fuel:get_name() ~= "default:coal_lump") then
			set_infotext(meta, 1)
			return
		end

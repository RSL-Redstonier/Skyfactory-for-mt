...
for number = 0, 35 do
mystical_agriculture.register_normal_ore_crop("uranium_"..number,"technic:uranium"..number.."_ingot","Uranium "..(number/10).." Fizzle",1,3,nil,"uranium_0_seeds.png","uranium_0_crop.png","uranium_0_essence.png")   
end
...
automation_crusher.crafts[#automation_crusher.crafts+1] = {output = "default:gravel", input = "default:cobble"}
automation_crusher.crafts[#automation_crusher.crafts+1] = {output = "default:sand", input = "default:gravel"}
automation_crusher.crafts[#automation_crusher.crafts+1] = {output = "default:dust", input = "default:sand"}

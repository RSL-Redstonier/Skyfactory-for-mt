...
minetest.register_craft({
		...
		recipe = {
			...
			{"default:steel_ingot", "dye:red", "dye:red", },
			{"microexpansion:steel_infused_obsidian_ingot", "default:steel_ingot", "microexpansion:steel_infused_obsidian_ingot", }
		}
	})
minetest.register_craft({
		...
		recipe = {
			{"microexpansion:cable", "microexpansion:cable", "microexpansion:cable", },
			{"microexpansion:fuel_fired_generator", "microexpansion:machine_casing", "microexpansion:fuel_fired_generator", },
			{"microexpansion:cable", "microexpansion:cable", "microexpansion:cable", }
		}
	})
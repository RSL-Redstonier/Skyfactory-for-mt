...
reg_waterican({material = "op", materialname = "Bedrockium", color = "#000000", chance = 1})
reg_waterican({material = "diamond", materialname = "Diamond", color = "#00FFFF", uses = 60, chance = 0.8})
reg_waterican({material = "mese", materialname = "Mese", color = "#FFFF00", uses = 50, chance = 0.7})
reg_waterican({material = "gold", materialname = "Gold", color = "#E6C717", uses = 40, chance = 0.6})
reg_waterican({material = "steel", materialname = "Steel", color = "#CCCCCC", uses = 30, chance = 0.5})
reg_waterican({material = "bronze", materialname = "Bronze", color = "#FF873D", uses = 20, chance = 0.4})
reg_waterican({material = "stone", materialname = "Stone", color = "#7F7F7F", uses = 15, chance = 0.3})
reg_waterican({material = "wood", materialname = "Wood", color = "#6C4913", uses = 10, chance = 0.2})

minetest.register_craft({
output = "waterican:waterican_op",
recipe = {
{"", " ", "skytest:bedrockium_ingot"},
{"skytest:bedrockium_ingot", "waterican:waterican_diamond", "skytest:bedrockium_ingot"},
{"", "skytest:bedrockium_ingot", ""}
		},
	})
	minetest.register_craft({
output = "waterican:waterican_diamond",
recipe = {
{"", " ", "default:diamond"},
{"default:diamond", "waterican:waterican_mese", "default:diamond"},
{"", "default:diamond", ""}
		},
	})
	minetest.register_craft({
	output = "waterican:waterican_mese",
recipe = {
	{"", " ", "default:mese_crystal"},
	{"default:mese_crystal", "waterican:waterican_gold", "default:mese_crystal"},
	{"", "default:mese_crystal", ""}
		},
	})
	minetest.register_craft({
	output = "waterican:waterican_gold",
recipe = {
	{"", " ", "default:gold_ingot"},
	{"default:gold_ingot", "waterican:waterican_steel", "default:gold_ingot"},
	{"", "default:gold_ingot", ""}
		},
	})
	minetest.register_craft({
	output = "waterican:waterican_steel",
recipe = {
	{"", " ", "default:steel_ingot"},
	{"default:steel_ingot", "waterican:waterican_bronze", "default:steel_ingot"},
	{"", "default:steel_ingot", ""}
		},
	})
minetest.register_craft({
	output = "waterican:waterican_bronze",
recipe = {
	{"", " ", "default:bronze_ingot"},
	{"default:bronze_ingot", "waterican:waterican_stone", "default:bronze_ingot"},
	{"", "default:bronze_ingot", ""}
		},
	})
minetest.register_craft({
	output = "waterican:waterican_stone",
recipe = {
	{"", " ", "default:cobble"},
	{"default:cobble", "waterican:waterican_wood", "default:cobble"},
	{"", "default:cobble", ""}
},
	})
	minetest.register_craft({
	output = "waterican:waterican_wood",
recipe = {
	{"", " ", "group:wood"},
